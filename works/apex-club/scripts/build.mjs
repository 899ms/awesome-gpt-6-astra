...
const files=['language.css','kart-model.js','kart-customization.js','garage-config.js','vehicle-finish.js','keyboard-controls.js','keyboard-settings.js','showroom-design.js','lobby.css','race-experience.js','track-layout.js','localization.js','pickup-design.js','citadel-gate.js','stunt-model.js','scene-design.js','index.html','style.css','bootstrap.js','game.js','driver-studio.js','kart-catalog.js','race-rules.js','driving-model.js','race-effects.js','race-audio.js','armored-kart.js','garage.html','garage.js','garage.css','mobile-controls.js'];
